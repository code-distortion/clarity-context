...
class FrameUnitTest extends PHPUnitTestCase
{
    ...
    private static function testCallStackFrame(
        ...
        self::testbuildCopyWithExtraMeta($frame, false, false);
        self::testbuildCopyWithExtraMeta($frame, false, true);
        self::testbuildCopyWithExtraMeta($frame, true, false);
        self::testbuildCopyWithExtraMeta($frame, true, true);
     ...
     * @return void
     */
    private static function testbuildCopyWithExtraMeta(
        Frame $frame,
        bool $thrownHere,
        bool $isLastApplicationFrame
    ): void {
