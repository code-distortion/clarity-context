...
Clarity Context is a part of the ***Clarity Suite***:
...
It gives you the option to turn this package on or off.
...
Clarity Context is a Context Tracker. It lets you add context details throughout your code, and it keeps track of what's currently in the call stack, ready for when an exception occurs.

Add context throughout your code in relevant places. Pick places to give you the most insight when tracking down a problem. Add as many as you feel necessary.

You can add strings to explain what's currently happening in a sentence, or associative arrays to show specific details about what your code is currently working with, for example.
...
You can pass more than one value at once:
...
This package doesn't actually log exceptions itself.

Use a package that's aware of *Clarity Context* (like [code-distortion/clarity-logger](https://github.com/code-distortion/clarity-logger)) to log your exceptions.

*Clarity Logger* will add your context details to the log automatically. e.g.
...
If you'd like to handle the logging yourself, or are building a package to do so - this involves:
- updating `app/Exceptions/Handler.php`
- getting it to read values from the `Context` object



## Logging Exceptions (Advanced)
 
This section explains how to you could go about loging exceptions yourself, using details from the `Context` object that this package produces.

To log exception details, you'll need to update the [exception handler](https://laravel.com/docs/10.x/errors#the-exception-handler) `app/Exceptions/Handler.php` of your Laravel project.
