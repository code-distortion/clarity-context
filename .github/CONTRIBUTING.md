...
- **Document any change in behaviour** - Clearly note any changes, so [Clarity Context's documentation](https://github.com/code-distortion/clarity-context) can be updated.
